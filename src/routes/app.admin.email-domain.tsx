        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-1">
            <button onClick={() => downloadCsv(timestampedName("email-delivery-history"), history, [
              { key: "created_at", label: "When", value: (r: SwitchRow) => r.created_at },
              { key: "action", label: "Event", value: (r: SwitchRow) => r.action },
              { key: "meta", label: "Detail", value: (r: SwitchRow) => r.meta ? JSON.stringify(r.meta) : "" },
